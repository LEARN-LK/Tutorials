#!/usr/bin/env bash
## Code below will send Alerts to Emails based on Host Notifications on Icinga2 using sendmail.
...
## You need to set up local mail server (eg: postfix) for this to work.
